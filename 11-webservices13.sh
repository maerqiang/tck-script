...
mkdir $RES/webservices13/JTwork
mkdir $RES/webservices13/JTreport
cd $TS_HOME/src/com/sun/ts/tests/webservices13
ant -Dwork.dir=$RES/webservices13/JTwork -Dreport.dir= $RES/webservices13/JTreport runclient > $RES/webservices13/webservices13-runclient.log
